...
# Clean up the extra authModal states left behind by the regex if needed.
# Let's do it safer.
...
# Render block
render_code = """  // Setup a wrapper for the project editor to handle URL parameters
...
# "  // Render landing page"
content = re.sub(r"  // Render landing page\n  if \(showLanding\).*export default App;\n?", render_code, content, flags=re.DOTALL)
